...
const Sidebar = ({ collapsed, onToggle }: SidebarProps) => {
  ...
  return (
    <div
      className={`fixed left-0 top-0 h-full bg-gray-800 border-r border-gray-700 transition-all duration-300 z-30 ${
        collapsed ? "w-16" : "w-64"
      }`}
    >
      <div className="flex items-center justify-between p-4 border-b border-gray-700">
        {!collapsed && (
          <div className="flex items-center gap-3">
            <img src="/cusp-logo-dark.png" alt="" className="w-32" />
